<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-12 min-h-screen">
    ...
    <div class="md:col-span-7 bg-gray-50 dark:bg-gray-900 p-4">
      <img src="../assets/images/logo/logo.svg" alt="Planner Logo" class="h-screen w-full" />
    </div>
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="#">
              ...
              <button type="submit"
                      class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Anmelden</button>
            </form>
          </div>
        </div>
      </div>
